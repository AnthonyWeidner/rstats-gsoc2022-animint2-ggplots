...
```{r}
#remotes::install_github("ropensci/gistr", force = TRUE)
```
...
#library("gistr")
#gist_auth()
#Sys.setenv(GITHUB_PAT = "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")
#remotes::install_github("sckott/gistr_oauth")
